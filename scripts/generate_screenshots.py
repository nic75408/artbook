...
# 读取合规样本
with open('data/evidence/acceptance_evidence_region_scope.json', 'r', encoding='utf-8') as f:
    ...
    browser.close()
        ...
        try:
            ...
            if result.returncode == 0 and screenshot_path.exists():
                ...
                print(f"  ✗ {vp_name}: {result.stderr[:100] if result.stderr else 'failed'}")
