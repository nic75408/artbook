...
// 后认为方形印章视觉上跟画作画框争夺焦点，且品牌四字自身书法韵味（原中文品牌文案已于 t_0bb5795e 改为「Art Daily」）
...
//        BrandLockup()                       // 默认「Art Daily」
//        BrandLockup({ label: 'Art Daily' })  // 显式指定文案
export function BrandLockup({ label = "Art Daily" } = {}) {
